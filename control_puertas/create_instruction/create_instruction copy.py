...
open = [b'\x8A', b'\x01', b'\x11']
response_open = [b'\x80', b'\x01', b'\x11']
response_close = [b'\x80', b'\x01', b'\x00']
status = [b'\x80', b'\x01', b'\x33']
...
for i in range(1, 6):
    ...
    print(byte_xor(byte_xor(byte_xor(open[0], open[1]), number_door), open[2]))
    print(i, byte_xor(byte_xor(byte_xor(response_open[0], response_open[1]), number_door), response_open[2]))
    print(i, byte_xor(byte_xor(byte_xor(response_close[0], response_close[1]), number_door), response_close[2]))
    print(i, byte_xor(byte_xor(byte_xor(response_open[0], response_open[1]), number_door), status[2]))
